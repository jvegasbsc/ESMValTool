"""
;;#############################################################################
;; C3S_511 MPQB Diagnostics
;; Author: Benjamin Mueller (LMU Munich, GER)
;; C3S_511 service
;;#############################################################################
;; Description
;;    Produces various general diagnostic plots, statistics and reports for the
;;    C3S_511 service
;;
...
;;    20181003-A_muel_bn: Routines written.
;;
;;#############################################################################
"""
...
from c3s_511_basic import Basic_Diagnostic_Multiproduct

def main(project_info):
    print('>>>>>>>> DUMMY_MPQB_C3S_511.py is running! <<<<<<<<<<<<')
...
# A_laue_ax-
    ...
    Diag = Basic_Diagnostic_Multiproduct()
