...
class SingleECV(BasicDiagnostics):
    """
    class to implement a single ECV diagnostics, like e.g. global means, global differences, RMSD etc.

    TODO implement testing for this diagnostic

    """
    def __init__(self, **kwargs):
        super(SingleECV, self).__init__(**kwargs)
        ...
        self._vartype = 'TCO' #default value as there must be one
	...
	def run_diagnostic(self):
        ...
        """
        super(SingleECV, self).run_diagnostic()
    ...
    def write_data(self,plot=True):
        ...
        write data
        """
        super(SingleECV, self).write_data()
    ...
    def _load_model_data(self):
		...
		print("test in Single_ECV_diagnostics.py, load_model_data")
    ...
    def _temporal_stability(self):
        ...
        print("    Temporal stability analysis not applicable for " + 
...
######################### unused
    def _preprocess_observations(self, infile, mod, var,check_f = None,force=False):
		...
		print('test in SingleECV_diagnostics.py')
