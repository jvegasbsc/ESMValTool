...
def do_report(report_data, report_title, work_dir, signature="", latex_opts=False):
    ...
    src_dir = path_out + os.sep + "source_" + report_title + "_" + signature+ "_" + pid # Sphinx source code directory
    bld_dir = path_out + os.sep + "build_" + report_title + "_" + signature+ "_" + pid  # Sphinx build directory
